...
bash$ gcc bp_gen.c -O3 -lm -o bp_gen
...
1. Generate a graph with 9000 total vertices, power law exponent of 2.5, 6000 vertices in X and 3000 in Y, with a maximum cardinality match that fully saturates Y:

bash$ ./bp_gen 10000 2.0 1.0 2.5
...
bash$ ./bp_gen 1000000 3.0 0.4 2.2
